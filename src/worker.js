...
export default {
  async fetch(request, env) {
    ...
    const isShortcutApiHost = hostname === "api-coche.cherrymakhome.com";

    // El subdominio api-coche es exclusivo para Atajos/NFC:
    // no sirve la PWA ni expone otras rutas de la API.
    if (isShortcutApiHost) {
    ...
    // En los demás hostnames, las rutas no-API siguen sirviendo la PWA.
...
function toFiniteNumber(value) {
  ...
  // Compatibilidad con clientes como Atajos de iOS, que pueden
  // serializar coordenadas numéricas como texto según el contexto/locale.
